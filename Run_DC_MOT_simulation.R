...
library(ggplot2) # nice plotting in R
library(ggpubr) # package for combining multiple ggplots
# dev.off()

# enter simulation parameters
date2day = '20200820' # todays date
...
delta_lup = configure_all_detunings(Xstate_split,rel_detun) # calculate all the detunings for each beam and each ground state
...
if (scan_type == 'position'){
  max_val = 25e-3 # [meters] max value of position
